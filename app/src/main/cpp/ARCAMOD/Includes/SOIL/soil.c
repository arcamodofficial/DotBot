...
#define SOIL_CHECK_FOR_GL_ERRORS 0
    ...
    #define glXGetProcAddressARB ((void*(*)(const GLubyte*))glXGetProcAddress)
    #endif
#endif
...
// Ganti GL_CLAMP_TO_EDGE dengan GL_CLAMP_TO_EDGE_TO_EDGE
unsigned int
    SOIL_internal_create_OGL_texture
    (
        const unsigned char *const data,
    ...
    )
{
    ...
    {
        unsigned int clamp_mode = GL_CLAMP_TO_EDGE; // Ganti GL_CLAMP dengan GL_CLAMP_TO_EDGE
    ...
    if( has_DXT_capability == SOIL_CAPABILITY_UNKNOWN )
    {
        ...
        } else
        {
            ...
            P_SOIL_GLCOMPRESSEDTEXIMAGE2DPROC ext_addr = NULL;
                ...
                CFRelease( bundle );
            #else
                // Hapus atau komentari kode berikut jika tidak diperlukan
                /*
                ext_addr = (P_SOIL_GLCOMPRESSEDTEXIMAGE2DPROC)
