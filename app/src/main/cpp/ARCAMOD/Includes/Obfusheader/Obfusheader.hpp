...
static volatile void obfusheader_decoy_main() {
    WATERMARK("Stop stealing bypass",
            "Specially to: Bypass stealer (AlphaMods)",
            "Try to make your own, Don't keep being an Noob",
            "Stop reversing the binary", // Message for crackers ;)
