...
#else
#define KITTY_LOGD(fmt, ...) (0)
#define KITTY_LOGI(fmt, ...) (0)
#define KITTY_LOGE(fmt, ...) (0)
#endif
...
namespace KittyMemory
{
     ...
     *  FAKE memcpy
     */
    void *MemCpy(void *dest, const void *src, size_t len) __attribute((__annotate__(("indibr"))));

    /*
     * mprotect wrapper
     */
    int setAddressProtection(void *address, size_t length, int protection) __attribute((__annotate__(("indibr"))));

    /*
     * Reads an address content into a buffer
     */
    bool memRead(const void *address, void *buffer, size_t len) __attribute((__annotate__(("indibr"))));
     ...
     */
    bool memWrite(void *address, const void *buffer, size_t len) __attribute((__annotate__(("indibr"))));
