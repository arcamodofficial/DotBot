...
#include "Il2cpp.h"
#define targetLib OBF("libil2cpp.so")
#define g_LogTag OBF("Bydz_Il2cpp")
typedef unsigned short UTF16;
typedef wchar_t UTF32;
typedef char UTF8;
namespace {
    IIL2CppString *(*il2cpp_string_new)(const char *str);
    IIL2CppString *(*il2cpp_string_new_utf16)(const wchar_t *str, int32_t length);
...
void *IL2Cpp::Il2CppGetClassType(const char *image, const char *namespaze, const char *clazz) {
    ...
    if (!img) {
        __android_log_print(ANDROID_LOG_ERROR, g_LogTag, OBF("Can't find image %s!"), image);
        return nullptr;
    }
    void *klass = il2cpp_class_from_name(img, namespaze, clazz);
    if (!klass) {
        __android_log_print(ANDROID_LOG_ERROR, g_LogTag, OBF("Can't find class %s!"), clazz);
        return nullptr;
    }
    cache[s] = klass;
    return klass;
...
void IL2Cpp::Il2CppGetStaticFieldValue(const char *image, const char *namespaze, const char *clazz, const char *name, void *output) {
    ...
    if (!klass) {
        __android_log_print(ANDROID_LOG_ERROR, g_LogTag, OBF("Can't find field %s!"), clazz, name);
        return;
    }
    void *field = il2cpp_class_get_field_from_name(klass, name);
    if (!field) {
        __android_log_print(ANDROID_LOG_ERROR, g_LogTag, OBF("Can't find field %s in class %s!"), name, clazz);
        return;
    }
...
void *IL2Cpp::Il2CppGetMethodOffset(const char *image, const char *namespaze, const char *clazz, const char *name, int argsCount) {
    ...
    void *klass = IL2Cpp::Il2CppGetClassType(image, namespaze, clazz);
    if (!klass) {
        __android_log_print(ANDROID_LOG_ERROR, g_LogTag, OBF("Can't find method %s!"), clazz, name);
        return nullptr;
    }
    void **method = (void**)il2cpp_class_get_method_from_name(klass, name, argsCount);
    if (!method) {
        __android_log_print(ANDROID_LOG_ERROR, g_LogTag, OBF("Can't find method %s in class %s!"), name, clazz);
        return nullptr;
    }
    __android_log_print(ANDROID_LOG_DEBUG, g_LogTag, OBF("%s - [%s] %s::%s: %p"), image, namespaze, clazz, name, *method);
    return *method;
}
size_t IL2Cpp::Il2CppGetFieldOffset(const char *image, const char *namespaze, const char *clazz, const char *name) {
    ...
    void *field = il2cpp_class_get_field_from_name(klass, name);
    if (!field) {
        __android_log_print(ANDROID_LOG_ERROR, g_LogTag, OBF("Can't find field %s in class %s!"), clazz, name);
        return -1;
    }
    auto result = il2cpp_field_get_offset(field);
    __android_log_print(ANDROID_LOG_DEBUG, g_LogTag, OBF("%s - [%s] %s::%s: %p"), image, namespaze, clazz, name, (void *) result);
    return result;
}
...
const char* IIL2CppString::CString() {
    return utf16_to_utf8(&this->start_char, this->length);
}
const wchar_t* IIL2CppString::WCString() {
    return utf16_to_utf32(&this->start_char, this->length);
}
IIL2CppString *IIL2CppString::Create(const char *s) {
    return il2cpp_string_new(s);
}
IIL2CppString *IIL2CppString::Create(const wchar_t *s, int len) {
...
void IL2Cpp::Il2CppAttach() {
    ...
    il2cpp_domain_get_assemblies = (void **(*)(const void *, size_t *)) dlsym(IL2Cpp_Handle, OBF("il2cpp_domain_get_assemblies"));
    il2cpp_string_new = (IIL2CppString *(*)(const char *)) dlsym(IL2Cpp_Handle, OBF("il2cpp_string_new"));
    il2cpp_string_new_utf16 = (IIL2CppString *(*)(const wchar_t *, int32_t)) dlsym(IL2Cpp_Handle, OBF("il2cpp_string_new_utf16"));
    il2cpp_domain_get = (void *(*)()) dlsym(IL2Cpp_Handle, OBF("il2cpp_domain_get"));
    il2cpp_assembly_get_image = (const void *(*)(const void *)) dlsym(IL2Cpp_Handle, OBF("il2cpp_assembly_get_image"));
    il2cpp_image_get_name = (const char *(*)(void *)) dlsym(IL2Cpp_Handle, OBF("il2cpp_image_get_name"));
    il2cpp_class_from_name = (void* (*)(const void*, const char*, const char *)) dlsym(IL2Cpp_Handle, OBF("il2cpp_class_from_name"));
    il2cpp_class_get_field_from_name = (void* (*)(void*, const char *)) dlsym(IL2Cpp_Handle, OBF("il2cpp_class_get_field_from_name"));
    il2cpp_field_static_get_value = (void (*)(void*, void *)) dlsym(IL2Cpp_Handle, OBF("il2cpp_field_static_get_value"));
    il2cpp_field_static_set_value = (void (*)(void*, void *)) dlsym(IL2Cpp_Handle, OBF("il2cpp_field_static_set_value"));
    il2cpp_class_get_method_from_name = (void* (*)(void *, const char*, int)) dlsym(IL2Cpp_Handle, OBF("il2cpp_class_get_method_from_name"));
    il2cpp_field_get_offset = (size_t (*)(void *)) dlsym(IL2Cpp_Handle, OBF("il2cpp_field_get_offset"));
