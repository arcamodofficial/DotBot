...
namespace ImGui
{
    ...
    IMGUI_API void          StyleColorsLight2(ImGuiStyle* dst = NULL);   // best used with borders and a custom, thicker font
    ...
    IMGUI_API bool          Begin(const char* name, bool* p_open = NULL, ImGuiWindowFlags flags = 0, bool showFpsInName = true, const char *separatorFps = "|");
    IMGUI_API void          End();
...
#define IM_DRAWLIST_TEX_LINES_WIDTH_MAX     (16)  // ARCAMOD: Optimized for mobile performance
#endif
